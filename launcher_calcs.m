...
v_ball_1 = sqrt((v_ball*cosd(angle_w1)*efficiency)^2 ...
    + (v_ball*sind(angle_w1)*efficiency)^2); % velocity imparted on ball from wheel 1: m/s
v_ball_2 = sqrt((v_ball*cosd(angle_w2)*efficiency)^2 ...
    + (v_ball*sind(angle_w2)*efficiency)^2); % velocity imparted on ball from wheel 2: m/s
